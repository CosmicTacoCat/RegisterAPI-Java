...
public abstract class BaseRepository<T extends BaseEntity<T>> implements BaseRepositoryInterface<T> {
	...
	public void saveMany(Collection<T> allToSave) {
		...
		try (Connection connection = DatabaseAccessor.getDatabaseConnection()) {
			try {
				...
				System.err.printf("A SQLException occurred in save many. The last attempted ID was %s. %s\n", lastAttemptedId.toString(), e.getMessage());
			} finally {
				connection.setAutoCommit(true);
			}
		} catch (SQLException e) {
			System.err.printf("A SQLException occurred in save many while attempting a connection. %s\n", e.getMessage());
	...
	public void deleteMany(Collection<T> allToDelete) {
		...
		try (Connection connection = DatabaseAccessor.getDatabaseConnection()) {
			try {
				...
				System.err.printf("A SQLException occurred in delete many. The last attempted ID was %s. %s\n", lastAttemptedId.toString(), e.getMessage());
			} finally {
				connection.setAutoCommit(true);
			}
		} catch (SQLException e) {
			System.err.printf("A SQLException occurred in delete many while attempting a connection. %s\n", e.getMessage());
		} catch (URISyntaxException e) {
			System.err.printf("A URISyntaxException occurred in delete many while attempting a connection. %s\n", e.getMessage());
		}
	}
	...
	public void connectAndRun(Consumer<Connection> action) {
		...
		try (Connection connection = DatabaseAccessor.getDatabaseConnection()) {
			...
			System.err.printf("A SQLException occurred in connect and run. %s\n", e.getMessage());
		} catch (URISyntaxException e) {
			System.err.printf("A URISyntaxException occurred in connect and run. %s\n", e.getMessage());
		}
	}
	...
	private Collection<T> selectAll(String query, UnaryOperator<PreparedStatement> setArgsOperator) {
		...
		try (Connection connection = DatabaseAccessor.getDatabaseConnection()) {
			...
			System.err.printf("A SQLException occurred in all query. %s\n", e.getMessage());
		} catch (URISyntaxException e) {
			System.err.printf("A URISyntaxException occurred in all query. %s\n", e.getMessage());
		}
	...
	private boolean exists(String query, UnaryOperator<PreparedStatement> setArgsOperator) {
		...
		try (Connection connection = DatabaseAccessor.getDatabaseConnection()) {
			...
			System.err.printf("A SQLException occurred in exists query. %s\n", e.getMessage());
		} catch (URISyntaxException e) {
			System.err.printf("A URISyntaxException occurred in exists query. %s\n", e.getMessage());
		}
	...
	private int count(String query, UnaryOperator<PreparedStatement> setArgsOperator) {
		...
		try (Connection connection = DatabaseAccessor.getDatabaseConnection()) {
			...
			System.err.printf("A SQLException occurred in count query. %s\n", e.getMessage());
		} catch (URISyntaxException e) {
			System.err.printf("A URISyntaxException occurred in count query. %s\n", e.getMessage());
		}
	...
	private void delete(String query, UnaryOperator<PreparedStatement> setArgsOperator) {
		try (Connection connection = DatabaseAccessor.getDatabaseConnection()) {
			...
			System.err.printf("A SQLException occurred in delete command. %s\n", e.getMessage());
		} catch (URISyntaxException e) {
			System.err.printf("A URISyntaxException occurred in delete command. %s\n", e.getMessage());
		}
	}
